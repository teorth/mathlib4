...
/-!
# Fourier-analytic auxiliary results

Auxiliary Fourier estimates used in the proof of the Wiener-Ikehara Tauberian theorem, notably
the decay of the Fourier transform of a `W^{2,1}` function.
